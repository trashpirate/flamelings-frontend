...
export default function Navbar({}: Props) {
  return (
    <nav className="mx-auto my-3 flex justify-between gap-5 align-middle md:w-full">
      <div className="bg-button hover:bg-buttonHover my-auto h-fit w-fit flex-row rounded-xl border-2 border-black font-bold text-black sm:w-36 sm:justify-between">
        <a
      ...
      <div className="bg-button hover:bg-buttonHover my-auto h-fit w-fit flex-row rounded-xl border-2 border-black font-bold text-black sm:w-44 sm:justify-between">
        <a
